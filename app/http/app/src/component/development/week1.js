...
- **Front-end 개발 진행**
    - **ReactJS, HTML, CSS, JavaScript**
        ...
        \`HTML\`을 이용하여 사이트에 여러가지 요소를 추가하고(Text, Image, Link 등)

        \`CSS\`, \`JavaScript\`를 이용하여 사이트를 꾸민다.

        \`ReactJS\`라는 Front-end Framework를 통해 개발 속도를 높일 수 있다.
    ...
    - **메인 페이지 완성**
        ...
        **4개의 메뉴로 구성.**
        ...
        - **상단 네비게이션 바(Introduction, Reviews, Communicate, Development)**
            ...
            섹션 페이지를 **새 창**으로 이동시킬지, **SPA(Single Page Application)**으로 구현할지 고민중.
            
            (따라서 **개발일지**를 작성할 위치가 정해지지 않아 임시적으로 메인페이지에 작성함.)
